...
public class PortalServiceDelegate extends EgiftifyServiceDelegate
{
	...
	public static final PortalServiceDelegate GET_CUSTOMER = new PortalServiceDelegate(
			"abc/rest.php",
			HttpMethod.POST,
			ContentType.APPLICATION_JSON
	);

	public static final PortalServiceDelegate GET_CUSTOMER_PARAM =
			new PortalServiceDelegate(
					"abc/rest.php",
					HttpMethod.POST,
