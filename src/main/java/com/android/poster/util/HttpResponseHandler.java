...
class StatusCode
{
     ...
     */
    private final Map<Integer, String> errorMap = new HashMap<Integer, String>() {{
        put(500, "We are unable to process your request. Please try after some time.");
        put(503, "Unable to connect with the server. Please try after some time."); // server is down
        put(404, "Unable to connect with the server. Please try after some time."); // not reachable (tomcat error)
    }};
